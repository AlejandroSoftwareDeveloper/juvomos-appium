...
// ConfigPage.js
const CIERRE_DIA_BUTTON = '//android.widget.LinearLayout[@resource-id="com.juvomos.pos:id/btnCloseDay"]';
const DISPOSITIVOS_BUTTON = '//android.widget.LinearLayout[@resource-id="com.juvomos.pos:id/btnDevices"]';
const CONFIG_GENERAL_BUTTON = '//android.widget.LinearLayout[@resource-id="com.juvomos.pos:id/generalSettingsBtn"]';
