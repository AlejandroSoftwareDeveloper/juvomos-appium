describe("Search product from Food", () => {
    ...
    let comp ='(//androidx.cardview.widget.CardView[@resource-id="com.juvomos.pos:id/itemGeneralLayout"])[1]/android.view.ViewGroup'
    let text = '//android.widget.TextView[@resource-id="com.juvomos.pos:id/category_product_name"]'
    //androidx.cardview.widget.CardView[@resource-id="com.juvomos.pos:id/itemGeneralLayout"])[2]/android.view.ViewGroup'
    // //android.widget.TextView[@resource-id="com.juvomos.pos:id/category_product_name"]'
    it("Data",async()=>{
        console.log(await $(comp).$(text).getText())
    })
