import { PIN_INPUT, CLOCK_IN_BUTTON, BACK_TO_PIN_BUTTON, REG_TIME_BUTTON } from '../../src/selectors/constants.js'
...
describe("Validate start work time process", () => {
    ...
    it("TC0004: Return to main window when click in close option" , async () => {
       ...
       await $('//android.widget.TextView[@resource-id="com.juvomos.pos:id/enterPinText"]').click()
   });
