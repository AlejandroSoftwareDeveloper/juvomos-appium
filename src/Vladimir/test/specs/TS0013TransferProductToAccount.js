...
describe("Transfer product from one accoun to another", () => {
    ...
    it("TC0002: Select first item.", async () => {
       ...
       item_to_transfer_description = await $('(//android.widget.TextView[@resource-id="com.juvomos.pos:id/itemInvoiceName"])[1]').getText()
    ...
    it("TC0004: Open menu and confirm account trasnfer", async () => {
      ...
      // Open second account
       await $(LAYOUT_CHECK_ITEM + '[2]').click()
